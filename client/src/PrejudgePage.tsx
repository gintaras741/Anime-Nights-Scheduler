...
export default function PrejudgePage() {
    ...
    const handlePrejudgeCrossOut = (stagename: string) => {
        socket.emit("prejudgeCrossedOut", stagename);
    };
    const handlePrejudgeGlowToggle = (stagename: string) => {
        socket.emit("prejudgeGlowToggle", stagename);
    };
    return (
